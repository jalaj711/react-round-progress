...
function CircularProgress(props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: canvasid + "-wrapper" },
            React.createElement("canvas", { id: canvasid, width: dimension, height: dimension }),
            props.showValue && (React.createElement("span", { className: canvasid + "-value" },
                props.value,
                "%"))),
